...
/**
 * 
 * 功能描述：资源工具类. 创建日期： 2012-9-15 作者： zhou gui ping
 */
public abstract class ResourceUtils
{
    ...
    {
        AssertUtil.assertNotNull(resourceLocation,
    ...
    public static File getFile(URL resourceUrl, String description)
        throws FileNotFoundException
    {
        AssertUtil.assertNotNull(resourceUrl, "Resource URL must not be null");
    ...
    public static File getFile(URI resourceUri, String description)
        throws FileNotFoundException
    {
        AssertUtil.assertNotNull(resourceUri, "Resource URI must not be null");
